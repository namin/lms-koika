...
int Snippet(int* x0) {
  ...
  while (x1 < 200 && (!(x11 == 0) || !(x9 == 0) || x2 < 9)) {
    ...
    if (1 == x15) {
      x27 = !((!(x21 == 2 || x21 == 1 || x21 == 1) || x24) && (!(x16 == 2 || x16 == 1 || x16 == 1) || x16 == 0));
      x4 = 2;
      x5 = x0[1];
      x6 = x0[1];
      x7 = 137001;
    ...
    if (3 == x15) {
      x27 = !((!(x21 == 4 || x21 == 3 || x21 == 2) || x24) && (!(x16 == 4 || x16 == 3 || x16 == 2) || x16 == 0));
      x4 = 4;
      x5 = x0[3];
      x6 = x0[2];
      x7 = 137001;
    ...
    if (4 == x15) {
      x27 = !((!(x21 == 1 || x21 == 4 || x21 == 3) || x24) && (!(x16 == 1 || x16 == 4 || x16 == 3) || x16 == 0));
      x4 = 1;
      x5 = x0[4];
      x6 = x0[3];
      x7 = 137001;
    ...
    if (5 == x15) {
      x27 = !((!(x21 == 2 || x21 == 1 || x21 == 4) || x24) && (!(x16 == 2 || x16 == 1 || x16 == 4) || x16 == 0));
      x4 = 2;
      x5 = x0[1];
      x6 = x0[4];
      x7 = 137001;
  ...
  if (!(x34 == 0)) x0[x34] = x14;
  bool x36 = x33 == 137002;
  if (x36) if (x5 == 0 || x6 == 0) x1 = x35 + 1;
  else x1 = x35 + 7;
  int x37 = x1 + 1;
  x1 = x37;
  if (!(x32 == 0)) x0[x32] = x33 == 137001 ? x5 + x6 : (x33 == 137003 ? x5 - x6 : (x36 ? x5 * x6 : (x33 == 137004 ? (x5 == x6 ? 1 : 0) : (x33 == 137005 ? (x5 != x6 ? 1 : 0) : (x33 == 137006 ? (x5 < x6 ? 1 : 0) : (x33 == 137007 ? (x5 > x6 ? 1 : 0) : (x33 == 137008 ? (x5 <= x6 ? 1 : 0) : (x33 == 137009 ? (x5 >= x6 ? 1 : 0) : 0))))))));
  if (x7 == 137002) if (x5 == 0 || x6 == 0) x1 = x37 + 1;
  else x1 = x37 + 7;
  return x1;
}
/*****************************************
...
int main(int argc, char *argv[]) {
  ...
  printf("\nexpected:\n");
  printf("0 8 13 21 42 0 0 0 0 0 0  ");
